...
(() => {
  ...
  class DocPage extends HTMLElement {
    ...
    _scheduleMeasure() {
      // A timer backstop: when the document loads in a hidden or
      // background frame, requestAnimationFrame never fires, the pending
      // handle blocks every later schedule, and paginated pages stay in
      // flowing mode. The timeout clears the stale handle and measures.
